 ...
 *
 * Description:
 *   L0 基础初始化 (IRQ/UART/GPIO), 在 board_early_initialize() 中调用。
 *   无阻塞、无堆、无总线操作。
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   L4-L5 应用级驱动注册 (AI/PM/WDT), 在 board_app_initialize() 中调用。
 *   NSH 任务上下文。
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   预留: 需文件系统/KVDB 的驱动注册, 在 board_app_finalinitialize() 中调用。
 *
 ****************************************************************************/
